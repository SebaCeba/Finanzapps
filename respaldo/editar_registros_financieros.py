...
def actualizar_panel(anio, mes):
    ...
    tabla = html.Table([
        html.Tr([
            html.Th("Categoría", style={"text-align": "center", "padding": "10px", "width": "30%", "vertical-align": "middle"}),
            html.Th("Registro Financiero", style={"text-align": "center", "padding": "10px", "width": "20%", "vertical-align": "middle"}),
            html.Th("Presupuesto", style={"text-align": "center", "padding": "10px", "width": "20%", "vertical-align": "middle"}),
            html.Th("Variación del Presupuesto", style={"text-align": "center", "padding": "10px", "width": "20%", "vertical-align": "middle"})
        ])
    ] + [
        html.Tr([
            html.Td(row["categoria"], style={"text-align": "left", "padding": "10px", "vertical-align": "middle"}),
            html.Td(dcc.Input(
            ...
            html.Td(f"{row['monto_presupuestado']:,.0f}".replace(",", "."), style={"text-align": "right", "padding": "10px", "vertical-align": "middle"}),
            html.Td(f"{row['variacion']:,.0f}".replace(",", "."), style={"text-align": "right", "padding": "10px", "vertical-align": "middle"})
